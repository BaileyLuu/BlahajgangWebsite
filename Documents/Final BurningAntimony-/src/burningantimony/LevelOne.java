...
public class LevelOne extends JFrame{
    ...
    final String originalText = "Welcome to Burning Antimony. Shall we continue?";
    //How many to shift by when encrypting. 
    final int shift = 1;
    //create a new text file to save the user game's progress
    File file = new File ("LevelOneProgress.txt");
    String temp ;
    ...
    private class Code {
        public Code() {
            //text to encrypt.
            String text = "Welcome to Burning Antimony. Shall we continue?";
