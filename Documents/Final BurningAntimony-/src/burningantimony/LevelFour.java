...
public class LevelFour extends JFrame{
    ...
    final String originalText = "Seems like you're ready for the boss level. ";
    //How many to shift by when encrypting. 
    final int shift = 18;
    //create a new text file to save the user game's progress
    File file = new File ("LevelFourProgress.txt");
    String temp ;
    ...
    private class Code {
        public Code() {
            //text to encrypt.
            String text = "Seems like you're ready for the boss level. ";
