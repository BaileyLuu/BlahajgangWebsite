...
public class LevelTwo extends JFrame{
    ...
    final String originalText = "Not hard? Then click on the go back button and continue this game. ";
    //How many to shift by when encrypting. 
    final int shift = 5;
    //create a new text file to save the user game's progress
    File file = new File ("LevelTwoProgress.txt");
    String temp ;
    ...
    private class Code {
        public Code() {
            //text to encrypt.
            String text = "Not hard? Then click on the go back button and continue this game. ";
