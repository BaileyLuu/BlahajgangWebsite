...
public class LevelFive extends JFrame{
    ...
    final String originalText = "Congrats to you. You have beated the program.";
    //How many to shift by when encrypting. 
    final int shift = 24;
    //create a new text file to save the user game's progress
    File file = new File ("LevelFiveProgress.txt");
    String temp ;
    ...
    private class Code {
        public Code() {
            //text to encrypt.
            String text = "Congrats to you. You have beated the program.";
